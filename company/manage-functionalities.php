        ...
        <div class="row pt-2 pb-2">
          <div class="col-md-6">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Functionalities</a></li>
              <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add Functionalities</a></li>
            </ol>
          </div>
        ...
        <div class="row pt-2 pb-2">
          <div class="col-md-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?= COMPANY_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
              <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Functionalities</a></li>
              <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Edit Functionalities</a></li>
            </ol>
          </div>
          <div class="col-md-6" style="display: flex;">
        ...
        <div class="row pt-2 pb-2">
          <div class="col-md-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?= COMPANY_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
              <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Functionalities</a></li>
              <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">View Functionalities</a></li>
            </ol>
          </div>
          <div class="col-md-6" style="display: flex;">
            <a href="<?= basename($_SERVER['PHP_SELF']); ?>"><button class="btn btn-danger btnstyle ml-2">Back</button></a>
            ...
            <div class="card card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <h3 class="card-title">Manage Functionalities</h3>
                ...
                <div class="card-body">
                  <div class="filter-col">
                    <div class="row">
                      <div class="col-md-2">
                        <div class="input-group">
                          <select name="functionalities_status" id="functionalities_status" class="form-control form-control-border borderColor">
                            <option value="">--- Status --</option>
                            <option value="active" <?php if (isset($_REQUEST['functionalities_status']) && 'active' == $_REQUEST['functionalities_status']) {
                                                      echo 'selected';
                                                    } ?>>Active</option>
                            <option value="inactive" <?php if (isset($_REQUEST['functionalities_status']) && 'inactive' == $_REQUEST['functionalities_status']) {
                                                        echo 'selected';
                                                      } ?>>Inactive</option>
                            <option value="draft" <?php if (isset($_REQUEST['functionalities_status']) && 'draft' == $_REQUEST['functionalities_status']) {
                                                    echo 'selected';
                                                  } ?>>Draft</option>
                          </select>
                        </div>
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                <div class="tab-pane fade show active" id="listTabPan" role="tabpanel" aria-labelledby="listTab">
                 ...
                 $sql_list = "SELECT * FROM `" . ERP_COMPANY_FUNCTIONALITIES . "` WHERE 1 " . $cond . " " . $sts . " AND company_id='" . $_SESSION["logedCompanyAdminInfo"]["fldAdminCompanyId"] . "' ORDER BY functionalities_id desc limit " . $GLOBALS['start'] . "," . $GLOBALS['show'] . " ";
                  $qry_list = mysqli_query($dbCon, $sql_list);
                  $num_list = mysqli_num_rows($qry_list);


                  $countShow = "SELECT count(*) FROM `" . ERP_COMPANY_FUNCTIONALITIES . "` WHERE 1 " . $cond . " AND company_id='" . $_SESSION["logedCompanyAdminInfo"]["fldAdminCompanyId"] . "' " . $sts . " ";
                  $countQry = mysqli_query($dbCon, $countShow);
                  $rowCount = mysqli_fetch_array($countQry);
                  $count = $rowCount[0];
                  $cnt = $GLOBALS['start'] + 1;
                  $settingsTable = getTableSettings(TBL_COMPANY_ADMIN_TABLESETTINGS, "ERP_COMPANY_FUNCTIONALITIES", $_SESSION["logedCompanyAdminInfo"]["adminId"]);
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <?php }
                            if (in_array(3, $settingsCheckbox)) { ?>
                              <td><?= $row['functionalities_created_by'] ?></td>
                            <?php }
                            if (in_array(4, $settingsCheckbox)) { ?>
                              <td><?= formatDateTime($row['functionalities_created_at']); ?></td>
                            <?php }
                            if (in_array(5, $settingsCheckbox)) { ?>
                              <td><?= $row['functionalities_updated_by'] ?></td>
                            <?php }
                            if (in_array(6, $settingsCheckbox)) { ?>
                              ...
                              <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                ...
                                <button <?php if ($row['functionalities_status'] == "draft") { ?> type="button" style="cursor: inherit; border:none" <?php } else { ?>type="submit" onclick="return confirm('Are you sure change Status?')" style="cursor: pointer; border:none" <?php } ?> class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="<?php echo $row['functionalities_status'] ?>">
                                  <?php if ($row['functionalities_status'] == "active") { ?>
                                    <span class="badge badge-success"><?php echo ucfirst($row['functionalities_status']); ?></span>
                                  <?php } else if ($row['functionalities_status'] == "inactive") { ?>
                                    <span class="badge badge-danger"><?php echo ucfirst($row['functionalities_status']); ?></span>
                                  <?php } else if ($row['functionalities_status'] == "draft") { ?>
                                    <span class="badge badge-warning"><?php echo ucfirst($row['functionalities_status']); ?></span>
                            ...
                            <td>
                              ...
                              <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $row['functionalities_id']; ?>" style="cursor: pointer;" class="btn btn-sm" title="View Branch"><i class="fa fa-eye"></i></a>
                              <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $row['functionalities_id']; ?>" style="cursor: pointer;" class="btn btn-sm" title="Edit Branch"><i class="fa fa-edit"></i></a>
