              ...
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                  <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                    <h3 class="card-title">Manage CreditTerms</h3>
                ...
                <div class="card-body">
                  <div class="filter-col">
                    <div class="row">
                      <div class="col-md-2">
                        <div class="input-group">
                          <select name="credit_terms_status" id="credit_terms_status" class="form-control form-control-border borderColor">
                            <option value="">--- Status --</option>
                            <option value="active" <?php if (isset($_REQUEST['credit_terms_status']) && 'active' == $_REQUEST['credit_terms_status']) {
                                                      echo 'selected';
                                                    } ?>>Active</option>
                            <option value="inactive" <?php if (isset($_REQUEST['credit_terms_status']) && 'inactive' == $_REQUEST['credit_terms_status']) {
                                                        echo 'selected';
                                                      } ?>>Inactive</option>
                            <option value="draft" <?php if (isset($_REQUEST['credit_terms_status']) && 'draft' == $_REQUEST['credit_terms_status']) {
                                                    echo 'selected';
                                                  } ?>>Draft</option>
                          </select>
                        </div>
                        ...
                        ?>
                          <tr>
                              ...
                              <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                ...
                                <button <?php if ($row['credit_terms_status'] == "draft") { ?> type="button" style="cursor: inherit; border:none" <?php } else { ?>type="submit" onclick="return confirm('Are you sure change Status?')" style="cursor: pointer; border:none" <?php } ?> class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="<?php echo $row['credit_terms_status'] ?>">
                                  <?php if ($row['credit_terms_status'] == "active") { ?>
                                    <span class="badge badge-success"><?php echo ucfirst($row['credit_terms_status']); ?></span>
                                  <?php } else if ($row['credit_terms_status'] == "inactive") { ?>
                                    <span class="badge badge-danger"><?php echo ucfirst($row['credit_terms_status']); ?></span>
                                  <?php } else if ($row['credit_terms_status'] == "draft") { ?>
                                    <span class="badge badge-warning"><?php echo ucfirst($row['credit_terms_status']); ?></span>
                            ...
                            <td>
                              ...
                              <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $row['credit_terms_id']; ?>" style="cursor: pointer;" class="btn btn-sm" title="View Branch"><i class="fa fa-eye"></i></a>
                              <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $row['credit_terms_id']; ?>" style="cursor: pointer;" class="btn btn-sm" title="Edit Branch"><i class="fa fa-edit"></i></a>
