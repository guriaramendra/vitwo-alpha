...
include("../app/v1/functions/vendor/func-branches.php");

administratorAuth();

if (isset($_POST["changeStatus"])) {
    $newStatusObj = ChangeStatusBranch($_POST,"itemId", "status");
    swalToast($newStatusObj["status"], $newStatusObj["message"]);
}


if (isset($_POST["create"])) {
    $addNewObj = createDataBranch($_POST+$_FILES);
    swalToast($addNewObj["status"], $addNewObj["message"]);
}

if (isset($_POST["edit"])) {
    $editDataObj = updateDataBranch($_POST);
	
    swalToast($editDataObj["status"], $editDataObj["message"]);
}

if (isset($_POST["add-table-settings"])) { 
	$editDataObj = updateInsertTableSettings($_POST);	
    swalToast($editDataObj["status"], $editDataObj["message"]);   
}
      ...
      <div class="row pt-2 pb-2">
        <div class="col-md-6">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Branch</a></li>
            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add Branch</a></li>
          </ol>
        </div>
        <div class="col-md-6" style="display: flex;">
          <button class="btn btn-danger btnstyle ml-2">Save As Draft</button>
          <button class="btn btn-primary btnstyle gradientBtn ml-2"><i class="fa fa-plus fontSize"></i> Post</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row pt-2 pb-2">
        <div class="col-md-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= VENDOR_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Branch</a></li>
            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Edit Branch</a></li>
          </ol>
        </div>
        <div class="col-md-6" style="display: flex;">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-md-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= VENDOR_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Branch</a></li>
            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">View Branch</a></li>
          </ol>
        </div>
        <div class="col-md-6" style="display: flex;">
          <a href="<?= basename($_SERVER['PHP_SELF']); ?>"><button class="btn btn-danger btnstyle ml-2">Back</button></a>
          ...
          <div class="card card-tabs">
            ...
            <div class="card-body">
                  ...
                  <div class="col-md-2">
                    <div class="input-group">
                      <select name="status_s" id="status_s" class="form-control form-control-border borderColor">
                        ...
                        <option value="active" <?php if(isset($_REQUEST['status_s']) && 'active'==$_REQUEST['status_s']){echo 'selected';} ?>>Active</option>
                        <option value="inactive" <?php if(isset($_REQUEST['status_s']) && 'inactive'==$_REQUEST['status_s']){echo 'selected';} ?>>Inactive</option>
                        <option value="draft" <?php if(isset($_REQUEST['status_s']) && 'draft'==$_REQUEST['status_s']){echo 'selected';} ?>>Draft</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                ...
                $sql_list = "SELECT * FROM `".ERP_BRANCHES."` WHERE 1 ".$cond." ".$sts."  ORDER BY itemId desc limit ".$GLOBALS['start'].",".$GLOBALS['show']." ";
                $qry_list = mysqli_query($dbCon,$sql_list);
                $num_list = mysqli_num_rows($qry_list);
                
                
                $countShow="SELECT count(*) FROM `".ERP_BRANCHES."` WHERE 1 ".$cond." ".$sts." ";
                ...
                ?>
                      <tr>
                        ...
                        <td >
                          ...
                          <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $row['itemId']; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-eye"></i></a>
                            <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $row['itemId']; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-edit"></i></a>
                ...
                <?php 
				$settingsTable=getTableSettings(TBL_VENDOR_ADMIN_TABLESETTINGS,"ERP_BRANCHES");
                ...
                <div class="modal" id="myModal2">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <input type="hidden" name="tablename" value="<?= TBL_VENDOR_ADMIN_TABLESETTINGS;?>" />
