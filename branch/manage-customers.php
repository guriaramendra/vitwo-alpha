            ...
            <div class="card-body">
              <div class="filter-col">
                <div class="row">
                  <div class="col-md-2">
                    <div class="input-group">
                      <select name="customer_status_s" id="customer_status_s" class="form-control form-control-border borderColor">
                        <option value="">--- Status --</option>
                        <option value="active" <?php if(isset($_REQUEST['customer_status_s']) && 'active'==$_REQUEST['customer_status_s']){echo 'selected';} ?>>Active</option>
                        <option value="inactive" <?php if(isset($_REQUEST['customer_status_s']) && 'inactive'==$_REQUEST['customer_status_s']){echo 'selected';} ?>>Inactive</option>
                        <option value="draft" <?php if(isset($_REQUEST['customer_status_s']) && 'draft'==$_REQUEST['customer_status_s']){echo 'selected';} ?>>Draft</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
              ...
              <div class="tab-content" id="custom-tabs-two-tabContent">
                ...
                $sql_list = "SELECT * FROM `".ERP_CUSTOMER."` WHERE 1 ".$cond." AND company_id='".$company_id."' AND branch_id='".$branch_id."' ".$sts."  ORDER BY customer_id desc limit ".$GLOBALS['start'].",".$GLOBALS['show']." ";
                $qry_list = mysqli_query($dbCon,$sql_list);
                $num_list = mysqli_num_rows($qry_list);
                
                
                $countShow="SELECT count(*) FROM `".ERP_CUSTOMER."` WHERE 1 ".$cond." AND company_id='".$company_id."' AND branch_id='".$branch_id."' ".$sts." ";
                ...
                ?>
                      <tr>
                        ...
                        <?php }if(in_array(4,$settingsCheckbox)){ ?>
                        <td><?= $row['customer_currency'] ?></td>
                        <?php }if(in_array(5,$settingsCheckbox)){ ?>
                        <td><?= $row['customer_language'] ?></td>                  
                        <?php }?>
                        <td>
                        ...
                        <td >
                          ...
                          <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $row['customer_id']; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-eye"></i></a>
                            <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $row['customer_id']; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-edit"></i></a>
