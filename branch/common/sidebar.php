  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?= BRANCH_URL ?>" class="nav-link">
        ...
        if ($_SESSION["logedBranchAdminInfo"]["adminRole"] == 1) {
          ?>
        ...
        <li class="nav-item">
          <a href="<?= BRANCH_URL ?>login.php?logoutAdminFromBranch" onclick="return confirm('Are you sure ?')" class="nav-link">
            <i class="nav-icon far fa-circle text-danger"></i>
            <p class="text">Back To Main</p>
          </a>
        </li>
        <?php }else{?>
        <li class="nav-header">Logout</li>
        <li class="nav-item">
          <a href="<?= BRANCH_URL ?>login.php?logoutAdminFromBranch" onclick="return confirm('Are you sure to logout?')" class="nav-link">
            <i class="nav-icon far fa-circle text-danger"></i>
