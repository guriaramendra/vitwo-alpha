...
if (isset($_POST["changeStatus"])) {
    $newStatusObj = ChangeStatusJournal($_POST,"id", "journal_status");
...
if (isset($_POST["editdata"])) {
    $editDataObj = updateDataJournal($_POST);
      ...
      <div class="row pt-2 pb-2">
        <div class="col-md-6">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Journal</a></li>
            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Add Journal</a></li>
          </ol>
        </div>
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div id="accordion">
              ...
              <div class="card card-primary">
                <div class="card-header cardHeader">
                  <h4 class="card-title w-100"> <a class="d-block w-100 text-dark" data-toggle="collapse" href="#collapseTwo"> Journal Admin Details </a> </h4>
                </div>
              ...
              <div class="col-md-12 mb-3">
                <div class="input-group">
                  <select name="goodsGroup" class="form-control form-control-border borderColor">
                    <option value="">Journal Group</option>
      ...
      <div class="row pt-2 pb-2">
        <div class="col-md-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= BRANCH_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Journal</a></li>
            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Edit Journal</a></li>
          </ol>
        </div>
        <div class="col-md-6" style="display: flex;">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-md-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= BRANCH_URL ?>" class="text-dark"><i class="fas fa-home"></i> Home</a></li>
            <li class="breadcrumb-item"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">Manage Journal</a></li>
            <li class="breadcrumb-item active"><a href="<?= basename($_SERVER['PHP_SELF']); ?>" class="text-dark">View Journal</a></li>
          </ol>
        </div>
        <div class="col-md-6" style="display: flex;">
          <a href="<?= basename($_SERVER['PHP_SELF']); ?>"><button class="btn btn-danger btnstyle ml-2">Back</button></a>
    ...
    <div class="container-fluid"> 
      ...
      <div class="row p-0 m-0">
        <div class="col-12 mt-2 p-0">
            ...
            <div class="card-header p-0 pt-1">
              <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                <li class="pt-2 px-3 d-flex justify-content-between align-items-center" style="width:100%">
                  <h3 class="card-title">Manage Journal</h3>
          ...
          $sts=" AND `journal_status` !='deleted'";	
          if(isset($_REQUEST['journal_status_s']) && $_REQUEST['journal_status_s']!=''){
            $sts=' AND journal_status="'.$_REQUEST['journal_status_s'].'"';
          }
          
          if(isset($_REQUEST['form_date_s']) && $_REQUEST['form_date_s']!=''){
            $cond.=" AND journal_created_by between '".$_REQUEST['form_date_s']." 00:00:00' AND '".$_REQUEST['to_date_s']." 23:59:59'";
          }
          
          if(isset($_REQUEST['keyword']) && $_REQUEST['keyword']!=''){
            $cond.=" AND (`invoice_no` like '%".$_REQUEST['keyword']."%' OR `remark` like '%".$_REQUEST['keyword']."%')";
          }	
				
                $sql_list = "SELECT * FROM `".ERP_ACC_JOURNAL."` WHERE 1 ".$cond." AND company_id='".$company_id."' AND branch_id='".$branch_id."' ".$sts."  ORDER BY id desc limit ".$GLOBALS['start'].",".$GLOBALS['show']." ";
                $qry_list = mysqli_query($dbCon,$sql_list);
                $num_list = mysqli_num_rows($qry_list);
                
                
                $countShow="SELECT count(*) FROM `".ERP_ACC_JOURNAL."` WHERE 1 ".$cond." AND company_id='".$company_id."' AND branch_id='".$branch_id."' ".$sts." ";
                ...
                if($num_list>0){
                ?>
                  <table id="mytable" class="table  table-hover text-nowrap table-responsive">
                    <thead>
                      <tr>
                        <th colspan="11">
                        <form name="search" id="search" action="<?php $_SERVER['PHP_SELF'];?>" method="get" onsubmit="return srch_frm();" >             
            <div class="card-body">
              <div class="filter-col" style="margin-top: -23px;">
                <div class="row">
                  <div class="col-md-2">
                    <div class="input-group">
                      <select name="journal_status_s" id="journal_status_s" class="form-control form-control-border borderColor">
                        <option value="">--- Status --</option>
                        <option value="active" <?php if(isset($_REQUEST['journal_status_s']) && 'active'==$_REQUEST['journal_status_s']){echo 'selected';} ?>>Active</option>
                        <option value="inactive" <?php if(isset($_REQUEST['journal_status_s']) && 'inactive'==$_REQUEST['journal_status_s']){echo 'selected';} ?>>Inactive</option>
                        <option value="draft" <?php if(isset($_REQUEST['journal_status_s']) && 'draft'==$_REQUEST['journal_status_s']){echo 'selected';} ?>>Draft</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-2">
              ...
              <a type="button" class="btn add-col" data-toggle="modal" data-target="#myModal2" style="position:absolute;z-index:999;"> <i class="fa fa-cog" aria-hidden="true"></i></a>
                    ...
                    while($row=mysqli_fetch_assoc($qry_list)){
                      $sql_debit = "SELECT * FROM `".ERP_ACC_DEBIT."` WHERE journal_id ='".$row["id"]."'";
                      $qry_debit = mysqli_query($dbCon,$sql_debit);
                      $num_debit = mysqli_num_rows($qry_debit);
                      $debit_row = mysqli_fetch_assoc($qry_debit);

                      $sql_credit = "SELECT * FROM `".ERP_ACC_CREDIT."` WHERE journal_id ='".$row["id"]."'";
                      $qry_credit = mysqli_query($dbCon,$sql_credit);
                      $num_credit = mysqli_num_rows($qry_debit);
                      $credit_row = mysqli_fetch_assoc($qry_credit);
                ?>
                      <tr>
                        <td><?=$cnt++?></td>
                        <?php if(in_array(1,$settingsCheckbox)){ ?>
                        ...
                        <?php }if(in_array(3,$settingsCheckbox)){ ?>
                        <td><?= formatDateTime($row['journal_created_at']); ?></td>
                        <?php }if(in_array(4,$settingsCheckbox)){ ?>
                        <td><?= $debit_row['debit_gl_code'] ?></td>
                        <?php }if(in_array(5,$settingsCheckbox)){ ?>
                        <td>Purchase A/C</td>                  
                        <?php }if(in_array(6,$settingsCheckbox)){ ?>
                        <td>Dr</td>
                        <?php }if(in_array(7,$settingsCheckbox)){ ?>
                        <td><?= $debit_row['debit_amount'] ?></td>                  
                        <?php }if(in_array(8,$settingsCheckbox)){ ?>
                        <td title="<?= $row['remark']; ?>"><?= WordLimiter($row['remark'],5); ?></td>                  
                        <?php }?>
                        <td>
						                  <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
                                <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
                                <input type="hidden" name="changeStatus" value="active_inactive">
                                <button <?php if($row['journal_status'] == "draft"){?> type="button"  style="cursor: inherit; border:none" <?php }else{?>type="submit" onclick="return confirm('Are you sure change journal_status?')"  style="cursor: pointer; border:none"<?php } ?> class="p-0 m-0 ml-2" data-toggle="tooltip" data-placement="top" title="<?php echo $row['journal_status'] ?>">
                                    <?php if($row['journal_status'] == "active"){ ?>
                                    <span class="badge badge-success"><?php echo ucfirst($row['journal_status']);?></span>
                                    <?php }else if($row['journal_status'] == "inactive"){?>
                                    <span class="badge badge-danger"><?php echo ucfirst($row['journal_status']);?></span>
                                    <?php }else if($row['journal_status'] == "draft"){?>
                                    <span class="badge badge-warning"><?php echo ucfirst($row['journal_status']);?></span>
                        ...
                        <td>
                          ...
                          <a href="<?= basename($_SERVER['PHP_SELF']) . "?view=" . $row['id']; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-eye"></i></a>
                            <a href="<?= basename($_SERVER['PHP_SELF']) . "?edit=" . $row['id']; ?>" style="cursor: pointer;" class="btn btn-sm"><i class="fa fa-edit"></i></a>
                      ...
                      <tr>
                        ...
                        <td>&nbsp;</td>
                        <?php }if(in_array(4,$settingsCheckbox)){ ?>
                        <td><?= $credit_row['credit_gl_code'] ?></td>
                        <?php }if(in_array(5,$settingsCheckbox)){ ?>
                        <td>Vendor A/C</td>                  
                        <?php }if(in_array(6,$settingsCheckbox)){ ?>
                        <td>Cr</td>
                        <?php }if(in_array(7,$settingsCheckbox)){ ?>
                        <td><?= $credit_row['credit_amount'] ?></td>                  
                        <?php }if(in_array(8,$settingsCheckbox)){ ?>
                        <td>&nbsp;</td>                  
                        <?php }?>
                        <td> &nbsp;</td> 
                      ...
                      <div class="modal-body">
                        ...
                        <div id="main2">
                          <table>
                            ...
                            <tr>
                              <td valign="top" style="width: 165px" ><input type="checkbox" <?php echo (in_array(6,$settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox5" value="6" />
                              Dr/Cr</td>
                            </tr>
                            <tr>
                              <td valign="top" style="width: 165px" ><input type="checkbox" <?php echo (in_array(7,$settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox5" value="7" />
                              Amount</td>
                            </tr>
                            <tr>
                              <td valign="top" style="width: 165px" ><input type="checkbox" <?php echo (in_array(8,$settingsCheckbox) ? 'checked="checked"' : ''); ?> name="settingsCheckbox[]" id="settingsCheckbox5" value="8" />
                              Remarks</td>
                            </tr>
                          </table>
                        </div>
