...
include("../app/v1/functions/branch/func-others-location.php");
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div id="accordion">
                ...
                <div id="collapseOne" class="collapse show" data-parent="#accordion">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="input-group">
                          <select id="othersLocation_flat_no" name="othersLocation_flat_no" class="form-control form-control-border borderColor">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="input-group">
                          <select id="othersLocation_street_name" name="othersLocation_street_name" class="form-control form-control-border borderColor">
              ...
              <div class="card card-primary">
                <div class="card-header cardHeader">
                  <h4 class="card-title w-100"> <a class="d-block w-100 text-dark" data-toggle="collapse" href="#collapseTwo"> Branch Location Admin Details </a> </h4>
                </div>
